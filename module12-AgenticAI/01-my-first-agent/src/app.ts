...
// * Customer Support Agend (Standard)
...
const triageAgent = Agent.create({
  ...
  handoffs: [
    ...
    handoff(escalationControlAgent, {
      ...
      onHandoff: async (_ctx: RunContext<EscalationData>, input: EscalationData | undefined) => {
...
// const result = await run(triageAgent, 'Hello');
// const result = await run(triageAgent, 'My pillow is terrible! I am very upset about that!');
